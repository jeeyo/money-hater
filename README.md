...
| --- | --- | --- |
| ![Day timeline of stops and cash expenses, with photos and spend](docs/screenshots/timeline.webp) | ![Trip detail with days, stops, and route map](docs/screenshots/trip-detail.webp) | ![Expenses converted into the base currency, searchable by description, merchant or place](docs/screenshots/expenses.webp) |
